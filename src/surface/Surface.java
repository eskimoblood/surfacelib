...
public class Surface {
     ...
     * @param i_surface
     */
    public Surface(PApplet pApplet, final Surface i_surface) {
        this(pApplet, i_surface.phiSteps, i_surface.thetaSteps, i_surface.maxTheta, i_surface.maxTheta, i_surface.minPhi, i_surface.minPhi, i_surface.parameter, null);
    ...
    public PShape getHorizontalStrip(final int i_indexTheta, final int i_startIndexPhi, final int i_endIndexPhi, final float i_radius) {
        return getHorizontalSegment(i_indexTheta, i_startIndexPhi, i_endIndexPhi, i_radius);
    }
...
//        i_endIndexPhi = Math.min(i_endIndexPhi, phiSteps);
//        i_endIndexTheta = Math.min(i_endIndexTheta, thetaSteps);
//        getVerticalStrip(i_startIndexPhi, i_startIndexTheta, i_endIndexTheta, i_radius);
//        getVerticalStrip(i_endIndexPhi, i_startIndexTheta, i_endIndexTheta, i_radius);
//        getHorizontalStrip(i_startIndexTheta, i_startIndexPhi, i_endIndexPhi, i_radius);
//        getHorizontalStrip(i_endIndexTheta - 1, i_startIndexPhi, i_endIndexPhi + 1, i_radius);
//        getPart(i_startIndexPhi, i_endIndexPhi, i_startIndexTheta, i_endIndexTheta - 1);
//        xScale += i_radius;
//        yScale += i_radius;
//        zScale += i_radius;
//        getPart(i_startIndexPhi, i_endIndexPhi, i_startIndexTheta, Math.max(i_startIndexTheta, i_endIndexTheta - 1));
//        xScale -= i_radius;
//        yScale -= i_radius;
//        zScale -= i_radius;
//        return g;
...
//        getVerticalStrip(i_startIndexPhi, i_startIndexTheta, i_endIndexTheta, i_radius);
//        getVerticalStrip(i_endIndexPhi, i_startIndexTheta, i_endIndexTheta, i_radius);
//        getHorizontalStrip(i_startIndexTheta, i_startIndexPhi, i_endIndexPhi + 1, i_radius);
//        getHorizontalStrip(i_endIndexTheta - 1, i_startIndexPhi, i_endIndexPhi + 1, i_radius);
//        getPart(i_startIndexPhi, i_endIndexPhi, i_startIndexTheta, i_endIndexTheta - 1);
//        xScale += i_radius;
//        yScale += i_radius;
...
//     *                          drawn if its 2 only every second an so on
//     */
//    public PShape drawHorizontalLinePart(final int i_startIndexPhi, final int i_endIndexPhi, final int i_startIndexTheta, final int i_endIndexTheta, final int i_stepPhi, final int i_stepTheta) {
//        for (int i = i_startIndexPhi; i < i_endIndexPhi; i += i_stepPhi) {
//            for (int j = i_startIndexTheta; j < i_endIndexTheta; j += i_stepTheta) {
//                drawHorizontalLineSegment(i, j);
//            }
...
//     *                   was initialized with.
//     */
//    public PShape drawHorizontalLineStrip(final int i_phiIndex) {
//        for (int j = 0; j < thetaSteps - 1; j++) {
...
//     *                     surface was initialized with.
//     */
//    public PShape drawHorizontalLineSegment(int i_phiIndex, int i_thetaIndex) {
...
//     */
//    public PShape drawVerticalLines() {
//        for (int i = 0; i < phiSteps - 1; i++) {
//            for (int j = 0; j < thetaSteps - 1; j++) {
...
//     *                     surface was initialized with.
//     */
//    public PShape drawVerticalLineStrip(final int i_thetaIndex) {
//        for (int i = 0; i < phiSteps - 1; i++) {
...
//     *                     surface was initialized with.
//     */
//    public PShape drawVerticalLineSegment(int i_phiIndex, int i_thetaIndex) {
//        i_phiIndex = Math.max(0, Math.min(i_phiIndex, phiSteps - phiSub));
//        i_thetaIndex = Math.max(0, Math.min(i_thetaIndex, thetaSteps - 1));
//        g.noFill();
//        g.beginShape();
